...
extern "C"
{
int sceVideoOutOpen(std::int32_t user_id, std::int32_t bus_type, std::int32_t index, const void *param);
...
template <typename T>
T MakeVkStruct(VkStructureType type)
{
    T value{};
    value.sType = type;
    return value;
...
{
template <typename T>
T LoadVulkanProc(VkInstance instance, const char *name)
{
...
bool Ps5VulkanRenderInterface::VulkanDispatch::LoadGlobal()
{
    ...
    vkEnumerateInstanceExtensionProperties = LoadVulkanProc<PFN_vkEnumerateInstanceExtensionProperties>(VK_NULL_HANDLE, "vkEnumerateInstanceExtensionProperties");
...
{
    vkAcquireNextImageKHR = LoadVulkanProc<PFN_vkAcquireNextImageKHR>(instance, "vkAcquireNextImageKHR");
    vkAllocateCommandBuffers = LoadVulkanProc<PFN_vkAllocateCommandBuffers>(instance, "vkAllocateCommandBuffers");
    vkAllocateDescriptorSets = LoadVulkanProc<PFN_vkAllocateDescriptorSets>(instance, "vkAllocateDescriptorSets");
    vkAllocateMemory = LoadVulkanProc<PFN_vkAllocateMemory>(instance, "vkAllocateMemory");
    vkBeginCommandBuffer = LoadVulkanProc<PFN_vkBeginCommandBuffer>(instance, "vkBeginCommandBuffer");
    ...
    vkCmdBeginRenderPass = LoadVulkanProc<PFN_vkCmdBeginRenderPass>(instance, "vkCmdBeginRenderPass");
    vkCmdBindDescriptorSets = LoadVulkanProc<PFN_vkCmdBindDescriptorSets>(instance, "vkCmdBindDescriptorSets");
    vkCmdBindIndexBuffer = LoadVulkanProc<PFN_vkCmdBindIndexBuffer>(instance, "vkCmdBindIndexBuffer");
    vkCmdBindPipeline = LoadVulkanProc<PFN_vkCmdBindPipeline>(instance, "vkCmdBindPipeline");
    vkCmdBindVertexBuffers = LoadVulkanProc<PFN_vkCmdBindVertexBuffers>(instance, "vkCmdBindVertexBuffers");
    vkCmdCopyBufferToImage = LoadVulkanProc<PFN_vkCmdCopyBufferToImage>(instance, "vkCmdCopyBufferToImage");
    ...
    vkCmdPipelineBarrier = LoadVulkanProc<PFN_vkCmdPipelineBarrier>(instance, "vkCmdPipelineBarrier");
    ...
    vkCreateDescriptorPool = LoadVulkanProc<PFN_vkCreateDescriptorPool>(instance, "vkCreateDescriptorPool");
    vkCreateDescriptorSetLayout = LoadVulkanProc<PFN_vkCreateDescriptorSetLayout>(instance, "vkCreateDescriptorSetLayout");
    vkCreateDevice = LoadVulkanProc<PFN_vkCreateDevice>(instance, "vkCreateDevice");
    vkCreateDisplayPlaneSurfaceKHR = LoadVulkanProc<PFN_vkCreateDisplayPlaneSurfaceKHR>(instance, "vkCreateDisplayPlaneSurfaceKHR");
    ...
    vkCreateGraphicsPipelines = LoadVulkanProc<PFN_vkCreateGraphicsPipelines>(instance, "vkCreateGraphicsPipelines");
    ...
    vkCreatePipelineLayout = LoadVulkanProc<PFN_vkCreatePipelineLayout>(instance, "vkCreatePipelineLayout");
    ...
    vkCreateShaderModule = LoadVulkanProc<PFN_vkCreateShaderModule>(instance, "vkCreateShaderModule");
    vkCreateSwapchainKHR = LoadVulkanProc<PFN_vkCreateSwapchainKHR>(instance, "vkCreateSwapchainKHR");
    vkDestroyBuffer = LoadVulkanProc<PFN_vkDestroyBuffer>(instance, "vkDestroyBuffer");
    vkDestroyCommandPool = LoadVulkanProc<PFN_vkDestroyCommandPool>(instance, "vkDestroyCommandPool");
    vkDestroyDescriptorPool = LoadVulkanProc<PFN_vkDestroyDescriptorPool>(instance, "vkDestroyDescriptorPool");
    vkDestroyDescriptorSetLayout = LoadVulkanProc<PFN_vkDestroyDescriptorSetLayout>(instance, "vkDestroyDescriptorSetLayout");
    ...
    vkDestroyFramebuffer = LoadVulkanProc<PFN_vkDestroyFramebuffer>(instance, "vkDestroyFramebuffer");
    ...
    vkDestroyPipelineLayout = LoadVulkanProc<PFN_vkDestroyPipelineLayout>(instance, "vkDestroyPipelineLayout");
    ...
    vkDestroyShaderModule = LoadVulkanProc<PFN_vkDestroyShaderModule>(instance, "vkDestroyShaderModule");
    vkDestroySurfaceKHR = LoadVulkanProc<PFN_vkDestroySurfaceKHR>(instance, "vkDestroySurfaceKHR");
    vkDestroySwapchainKHR = LoadVulkanProc<PFN_vkDestroySwapchainKHR>(instance, "vkDestroySwapchainKHR");
    vkEndCommandBuffer = LoadVulkanProc<PFN_vkEndCommandBuffer>(instance, "vkEndCommandBuffer");
    vkEnumerateDeviceExtensionProperties = LoadVulkanProc<PFN_vkEnumerateDeviceExtensionProperties>(instance, "vkEnumerateDeviceExtensionProperties");
    vkEnumeratePhysicalDevices = LoadVulkanProc<PFN_vkEnumeratePhysicalDevices>(instance, "vkEnumeratePhysicalDevices");
    vkFreeCommandBuffers = LoadVulkanProc<PFN_vkFreeCommandBuffers>(instance, "vkFreeCommandBuffers");
    vkFreeMemory = LoadVulkanProc<PFN_vkFreeMemory>(instance, "vkFreeMemory");
    vkGetBufferMemoryRequirements = LoadVulkanProc<PFN_vkGetBufferMemoryRequirements>(instance, "vkGetBufferMemoryRequirements");
    vkGetDeviceQueue = LoadVulkanProc<PFN_vkGetDeviceQueue>(instance, "vkGetDeviceQueue");
    vkGetDisplayModePropertiesKHR = LoadVulkanProc<PFN_vkGetDisplayModePropertiesKHR>(instance, "vkGetDisplayModePropertiesKHR");
    vkGetDisplayPlaneCapabilitiesKHR = LoadVulkanProc<PFN_vkGetDisplayPlaneCapabilitiesKHR>(instance, "vkGetDisplayPlaneCapabilitiesKHR");
    vkGetDisplayPlaneSupportedDisplaysKHR = LoadVulkanProc<PFN_vkGetDisplayPlaneSupportedDisplaysKHR>(instance, "vkGetDisplayPlaneSupportedDisplaysKHR");
    vkGetImageMemoryRequirements = LoadVulkanProc<PFN_vkGetImageMemoryRequirements>(instance, "vkGetImageMemoryRequirements");
    vkGetPhysicalDeviceDisplayPlanePropertiesKHR = LoadVulkanProc<PFN_vkGetPhysicalDeviceDisplayPlanePropertiesKHR>(instance, "vkGetPhysicalDeviceDisplayPlanePropertiesKHR");
    vkGetPhysicalDeviceDisplayPropertiesKHR = LoadVulkanProc<PFN_vkGetPhysicalDeviceDisplayPropertiesKHR>(instance, "vkGetPhysicalDeviceDisplayPropertiesKHR");
    vkGetPhysicalDeviceMemoryProperties = LoadVulkanProc<PFN_vkGetPhysicalDeviceMemoryProperties>(instance, "vkGetPhysicalDeviceMemoryProperties");
    vkGetPhysicalDeviceFormatProperties = LoadVulkanProc<PFN_vkGetPhysicalDeviceFormatProperties>(instance, "vkGetPhysicalDeviceFormatProperties");
    vkGetPhysicalDeviceQueueFamilyProperties = LoadVulkanProc<PFN_vkGetPhysicalDeviceQueueFamilyProperties>(instance, "vkGetPhysicalDeviceQueueFamilyProperties");
    vkGetPhysicalDeviceSurfaceCapabilitiesKHR = LoadVulkanProc<PFN_vkGetPhysicalDeviceSurfaceCapabilitiesKHR>(instance, "vkGetPhysicalDeviceSurfaceCapabilitiesKHR");
    vkGetPhysicalDeviceSurfaceFormatsKHR = LoadVulkanProc<PFN_vkGetPhysicalDeviceSurfaceFormatsKHR>(instance, "vkGetPhysicalDeviceSurfaceFormatsKHR");
    vkGetPhysicalDeviceSurfacePresentModesKHR = LoadVulkanProc<PFN_vkGetPhysicalDeviceSurfacePresentModesKHR>(instance, "vkGetPhysicalDeviceSurfacePresentModesKHR");
    vkGetPhysicalDeviceSurfaceSupportKHR = LoadVulkanProc<PFN_vkGetPhysicalDeviceSurfaceSupportKHR>(instance, "vkGetPhysicalDeviceSurfaceSupportKHR");
    vkGetSwapchainImagesKHR = LoadVulkanProc<PFN_vkGetSwapchainImagesKHR>(instance, "vkGetSwapchainImagesKHR");
    ...
    vkUpdateDescriptorSets = LoadVulkanProc<PFN_vkUpdateDescriptorSets>(instance, "vkUpdateDescriptorSets");
...
bool Ps5VulkanRenderInterface::Initialize(const char *vertex_shader_path, const char *fragment_shader_path)
{
...
bool Ps5VulkanRenderInterface::CreateInstance()
{
    ...
    if (!CheckResult(dispatch_.vkEnumerateInstanceExtensionProperties(nullptr, &count, extensions.data()),
    ...
    VkApplicationInfo app_info = MakeVkStruct<VkApplicationInfo>(VK_STRUCTURE_TYPE_APPLICATION_INFO);
    ...
    VkInstanceCreateInfo create_info = MakeVkStruct<VkInstanceCreateInfo>(VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO);
    create_info.pApplicationInfo = &app_info;
    create_info.enabledExtensionCount = 2;
    create_info.ppEnabledExtensionNames = instance_extensions;
    return CheckResult(dispatch_.vkCreateInstance(&create_info, nullptr, &instance_), "vkCreateInstance");
}

bool Ps5VulkanRenderInterface::ChooseDisplayConfiguration()
{
    uint32_t display_count = 0;
    if (!CheckResult(dispatch_.vkGetPhysicalDeviceDisplayPropertiesKHR(physical_device_, &display_count, nullptr),
                     "dispatch_.vkGetPhysicalDeviceDisplayPropertiesKHR(count)"))
        return false;
    if (display_count == 0)
        return false;
    std::vector<VkDisplayPropertiesKHR> displays(display_count);
    if (!CheckResult(dispatch_.vkGetPhysicalDeviceDisplayPropertiesKHR(physical_device_, &display_count, displays.data()),
    ...
    if (!CheckResult(dispatch_.vkGetDisplayModePropertiesKHR(physical_device_, display_, &mode_count, nullptr),
                     "dispatch_.vkGetDisplayModePropertiesKHR(count)"))
        return false;
    if (mode_count == 0)
        return false;
    std::vector<VkDisplayModePropertiesKHR> modes(mode_count);
    if (!CheckResult(dispatch_.vkGetDisplayModePropertiesKHR(physical_device_, display_, &mode_count, modes.data()),
    ...
    const std::uint32_t target_height = active.pane_height ? active.pane_height : active.full_height;
    ...
    std::fprintf(stderr, "[PS5-Vulkan] selected display mode: %ux%u%s\n", display_width_, display_height_,
...
bool Ps5VulkanRenderInterface::CreateSurface()
{
    ...
    if (!CheckResult(dispatch_.vkGetPhysicalDeviceDisplayPlanePropertiesKHR(physical_device_, &plane_count, nullptr),
                     "dispatch_.vkGetPhysicalDeviceDisplayPlanePropertiesKHR(count)"))
        return false;
    if (plane_count == 0)
        return false;
    std::vector<VkDisplayPlanePropertiesKHR> planes(plane_count);
    if (!CheckResult(dispatch_.vkGetPhysicalDeviceDisplayPlanePropertiesKHR(physical_device_, &plane_count, planes.data()),
    ...
    for (std::uint32_t plane = 0; plane < plane_count; ++plane)
    {
        ...
        if (dispatch_.vkGetDisplayPlaneSupportedDisplaysKHR(physical_device_, plane, &supported_count, nullptr) != VK_SUCCESS)
            continue;
        std::vector<VkDisplayKHR> supported(supported_count);
        if (supported_count && dispatch_.vkGetDisplayPlaneSupportedDisplaysKHR(physical_device_, plane, &supported_count,
    ...
    if (!CheckResult(dispatch_.vkGetDisplayPlaneCapabilitiesKHR(physical_device_, display_mode_, selected_plane, &plane_caps),
    ...
    VkDisplaySurfaceCreateInfoKHR surface_info = MakeVkStruct<VkDisplaySurfaceCreateInfoKHR>(VK_STRUCTURE_TYPE_DISPLAY_SURFACE_CREATE_INFO_KHR);
    ...
    return CheckResult(dispatch_.vkCreateDisplayPlaneSurfaceKHR(instance_, &surface_info, nullptr, &surface_),
...
{
    uint32_t count = 0;
    if (!CheckResult(dispatch_.vkEnumeratePhysicalDevices(instance_, &count, nullptr), "dispatch_.vkEnumeratePhysicalDevices(count)"))
        return false;
    if (count == 0)
        return false;
...
{
    uint32_t count = 0;
    if (!CheckResult(dispatch_.vkGetPhysicalDeviceSurfaceFormatsKHR(physical_device_, surface_, &count, nullptr),
                     "dispatch_.vkGetPhysicalDeviceSurfaceFormatsKHR(count)"))
        return false;
    if (count == 0)
        return false;
    std::vector<VkSurfaceFormatKHR> formats(count);
    if (!CheckResult(dispatch_.vkGetPhysicalDeviceSurfaceFormatsKHR(physical_device_, surface_, &count, formats.data()),
...
{
    uint32_t count = 0;
    if (!CheckResult(dispatch_.vkGetPhysicalDeviceSurfacePresentModesKHR(physical_device_, surface_, &count, nullptr),
                     "dispatch_.vkGetPhysicalDeviceSurfacePresentModesKHR(count)"))
        return false;
    std::vector<VkPresentModeKHR> modes(count);
    if (count && !CheckResult(dispatch_.vkGetPhysicalDeviceSurfacePresentModesKHR(physical_device_, surface_, &count, modes.data()),
...
bool Ps5VulkanRenderInterface::CreateDevice()
{
    ...
    dispatch_.vkGetPhysicalDeviceQueueFamilyProperties(physical_device_, &queue_count, queues.data());
    for (std::uint32_t i = 0; i < queue_count; ++i)
    {
        if ((queues[i].queueFlags & VK_QUEUE_GRAPHICS_BIT) != 0 && graphics_queue_family_ == UINT32_MAX)
    ...
    VkDeviceQueueCreateInfo graphics_queue = MakeVkStruct<VkDeviceQueueCreateInfo>(VK_STRUCTURE_TYPE_DEVICE_QUEUE_CREATE_INFO);
    ...
    {
        VkDeviceQueueCreateInfo present_queue = MakeVkStruct<VkDeviceQueueCreateInfo>(VK_STRUCTURE_TYPE_DEVICE_QUEUE_CREATE_INFO);
    ...
    VkDeviceCreateInfo create_info = MakeVkStruct<VkDeviceCreateInfo>(VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO);
    create_info.queueCreateInfoCount = static_cast<std::uint32_t>(queue_infos.size());
    create_info.pQueueCreateInfos = queue_infos.data();
    create_info.enabledExtensionCount = 1;
    create_info.ppEnabledExtensionNames = device_extensions;
    create_info.pEnabledFeatures = &features;
    if (!CheckResult(dispatch_.vkCreateDevice(physical_device_, &create_info, nullptr, &device_), "vkCreateDevice"))
        return false;
...
bool Ps5VulkanRenderInterface::CreateSwapchain()
{
    ...
    if (!CheckResult(dispatch_.vkGetPhysicalDeviceSurfaceCapabilitiesKHR(physical_device_, surface_, &caps),
    ...
    VkSwapchainCreateInfoKHR swapchain_info = MakeVkStruct<VkSwapchainCreateInfoKHR>(VK_STRUCTURE_TYPE_SWAPCHAIN_CREATE_INFO_KHR);
    ...
    if (!CheckResult(dispatch_.vkGetSwapchainImagesKHR(device_, swapchain_, &count, swapchain_images_.data()),
                     "dispatch_.vkGetSwapchainImagesKHR(data)"))
        return false;
    swapchain_views_.resize(count);
    for (std::uint32_t i = 0; i < count; ++i)
    {
        VkImageViewCreateInfo view_info = MakeVkStruct<VkImageViewCreateInfo>(VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO);
        ...
        if (!CheckResult(dispatch_.vkCreateImageView(device_, &view_info, nullptr, &swapchain_views_[i]),
                         "vkCreateImageView"))
            return false;
    }
    return true;
...
bool Ps5VulkanRenderInterface::CreateRenderPass()
{
    ...
    VkRenderPassCreateInfo info = MakeVkStruct<VkRenderPassCreateInfo>(VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO);
    ...
    return CheckResult(dispatch_.vkCreateRenderPass(device_, &info, nullptr, &render_pass_), "vkCreateRenderPass");
}
...
bool Ps5VulkanRenderInterface::CreateDescriptorResources()
{
    ...
    VkDescriptorSetLayoutCreateInfo layout_info = MakeVkStruct<VkDescriptorSetLayoutCreateInfo>(VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO);
    layout_info.bindingCount = 1;
    layout_info.pBindings = &binding;
    if (!CheckResult(dispatch_.vkCreateDescriptorSetLayout(device_, &layout_info, nullptr, &descriptor_set_layout_),
    ...
    VkDescriptorPoolCreateInfo pool_info = MakeVkStruct<VkDescriptorPoolCreateInfo>(VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO);
    pool_info.maxSets = kDescriptorCapacity;
    pool_info.poolSizeCount = 1;
    pool_info.pPoolSizes = &size;
    if (!CheckResult(dispatch_.vkCreateDescriptorPool(device_, &pool_info, nullptr, &descriptor_pool_),
                     "vkCreateDescriptorPool"))
        return false;

    VkSamplerCreateInfo sampler_info = MakeVkStruct<VkSamplerCreateInfo>(VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO);
    ...
    if (!CheckResult(dispatch_.vkCreateSampler(device_, &sampler_info, nullptr, &sampler_), "vkCreateSampler"))
        return false;
    ...
    mipmap_sampler_info.mipmapMode = linear_filter ? VK_SAMPLER_MIPMAP_MODE_LINEAR : VK_SAMPLER_MIPMAP_MODE_NEAREST;
    mipmap_sampler_info.maxLod = 16.0f;
    if (!linear_filter)
        std::fprintf(stderr, "[PS5-Vulkan] linear filtering unavailable for RGBA8; mip selection uses nearest filtering\n");
    return CheckResult(dispatch_.vkCreateSampler(device_, &mipmap_sampler_info, nullptr, &mipmap_sampler_),
...
VkShaderModule Ps5VulkanRenderInterface::CreateShaderModule(const std::vector<std::uint8_t> &spirv)
{
    ...
    VkShaderModuleCreateInfo info = MakeVkStruct<VkShaderModuleCreateInfo>(VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO);
...
bool Ps5VulkanRenderInterface::CreatePipeline(const char *vertex_shader_path, const char *fragment_shader_path)
{
    ...
    VkPipelineVertexInputStateCreateInfo vertex_input = MakeVkStruct<VkPipelineVertexInputStateCreateInfo>(VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO);
    vertex_input.vertexBindingDescriptionCount = 1;
    vertex_input.pVertexBindingDescriptions = &binding;
    vertex_input.vertexAttributeDescriptionCount = 3;
    vertex_input.pVertexAttributeDescriptions = attributes;

    VkPipelineInputAssemblyStateCreateInfo input_assembly = MakeVkStruct<VkPipelineInputAssemblyStateCreateInfo>(VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO);
    ...
    VkPipelineViewportStateCreateInfo viewport_state = MakeVkStruct<VkPipelineViewportStateCreateInfo>(VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO);
    viewport_state.viewportCount = 1;
    viewport_state.pViewports = &viewport;
    viewport_state.scissorCount = 1;
    viewport_state.pScissors = &scissor;

    VkPipelineRasterizationStateCreateInfo raster = MakeVkStruct<VkPipelineRasterizationStateCreateInfo>(VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO);
    ...
    VkPipelineColorBlendStateCreateInfo blend_state = MakeVkStruct<VkPipelineColorBlendStateCreateInfo>(VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO);
    blend_state.attachmentCount = 1;
    blend_state.pAttachments = &blend;

    const VkDynamicState dynamic_states[] = {VK_DYNAMIC_STATE_VIEWPORT, VK_DYNAMIC_STATE_SCISSOR};
    VkPipelineDynamicStateCreateInfo dynamic_state = MakeVkStruct<VkPipelineDynamicStateCreateInfo>(VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO);
    ...
    VkPipelineLayoutCreateInfo layout = MakeVkStruct<VkPipelineLayoutCreateInfo>(VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO);
    layout.setLayoutCount = 1;
    layout.pSetLayouts = &descriptor_set_layout_;
    layout.pushConstantRangeCount = 1;
    layout.pPushConstantRanges = &push;
    if (!CheckResult(dispatch_.vkCreatePipelineLayout(device_, &layout, nullptr, &pipeline_layout_), "vkCreatePipelineLayout"))
        return false;

    VkGraphicsPipelineCreateInfo pipeline_info = MakeVkStruct<VkGraphicsPipelineCreateInfo>(VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_CREATE_INFO);
    ...
    const bool ok = CheckResult(dispatch_.vkCreateGraphicsPipelines(device_, VK_NULL_HANDLE, 1, &pipeline_info, nullptr, &pipeline_),
...
{
    VkBufferCreateInfo buffer_info = MakeVkStruct<VkBufferCreateInfo>(VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO);
    buffer_info.size = size;
    buffer_info.usage = usage;
    buffer_info.sharingMode = VK_SHARING_MODE_EXCLUSIVE;
    if (!CheckResult(dispatch_.vkCreateBuffer(device_, &buffer_info, nullptr, &buffer), "vkCreateBuffer"))
        return false;
    VkMemoryRequirements requirements{};
    dispatch_.vkGetBufferMemoryRequirements(device_, buffer, &requirements);
    VkMemoryAllocateInfo allocation = MakeVkStruct<VkMemoryAllocateInfo>(VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO);
    ...
    if (allocation.memoryTypeIndex == UINT32_MAX)
        return false;
    if (!CheckResult(dispatch_.vkAllocateMemory(device_, &allocation, nullptr, &memory), "dispatch_.vkAllocateMemory(buffer)"))
        return false;
    if (!CheckResult(dispatch_.vkBindBufferMemory(device_, buffer, memory, 0), "vkBindBufferMemory"))
        return false;
    if (mapped && (properties & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT))
    {
        if (!CheckResult(dispatch_.vkMapMemory(device_, memory, 0, VK_WHOLE_SIZE, 0, mapped), "vkMapMemory"))
            return false;
    }
    return true;
}

bool Ps5VulkanRenderInterface::CreateImage(std::uint32_t width, std::uint32_t height, VkFormat format,
                                             VkImageUsageFlags usage, VkImage &image, VkDeviceMemory &memory,
                                             std::uint32_t mip_levels)
{
    VkImageCreateInfo image_info = MakeVkStruct<VkImageCreateInfo>(VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO);
    ...
    if (!CheckResult(dispatch_.vkCreateImage(device_, &image_info, nullptr, &image), "vkCreateImage"))
        return false;
    VkMemoryRequirements requirements{};
    ...
    if (allocation.memoryTypeIndex == UINT32_MAX)
        allocation.memoryTypeIndex = FindMemoryType(requirements.memoryTypeBits, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT |
                                                       VK_MEMORY_PROPERTY_HOST_COHERENT_BIT);
    if (allocation.memoryTypeIndex == UINT32_MAX)
        return false;
    if (!CheckResult(dispatch_.vkAllocateMemory(device_, &allocation, nullptr, &memory), "dispatch_.vkAllocateMemory(image)"))
        return false;
...
bool Ps5VulkanRenderInterface::BeginSingleUseCommands(VkCommandBuffer &buffer, VkCommandPool &pool)
{
    ...
    {
        VkCommandPoolCreateInfo pool_info = MakeVkStruct<VkCommandPoolCreateInfo>(VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO);
        pool_info.queueFamilyIndex = graphics_queue_family_;
        pool_info.flags = VK_COMMAND_POOL_CREATE_TRANSIENT_BIT | VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT;
        if (!CheckResult(dispatch_.vkCreateCommandPool(device_, &pool_info, nullptr, &pool), "dispatch_.vkCreateCommandPool(upload)"))
            return false;
    }
    VkCommandBufferAllocateInfo allocation = MakeVkStruct<VkCommandBufferAllocateInfo>(VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO);
    allocation.commandPool = pool;
    allocation.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
    allocation.commandBufferCount = 1;
    if (!CheckResult(dispatch_.vkAllocateCommandBuffers(device_, &allocation, &buffer), "dispatch_.vkAllocateCommandBuffers(upload)"))
        return false;
    VkCommandBufferBeginInfo begin = MakeVkStruct<VkCommandBufferBeginInfo>(VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO);
    begin.flags = VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT;
    return CheckResult(dispatch_.vkBeginCommandBuffer(buffer, &begin), "dispatch_.vkBeginCommandBuffer(upload)");
}
...
bool Ps5VulkanRenderInterface::EndSingleUseCommands(VkCommandBuffer buffer, VkCommandPool pool)
{
    ...
    if (!CheckResult(dispatch_.vkQueueSubmit(graphics_queue_, 1, &submit, VK_NULL_HANDLE), "dispatch_.vkQueueSubmit(upload)"))
        return false;
    if (!CheckResult(dispatch_.vkQueueWaitIdle(graphics_queue_), "dispatch_.vkQueueWaitIdle(upload)"))
        return false;
                                                ...
                                                std::uint32_t mip_levels)
{
    ...
    dispatch_.vkCmdPipelineBarrier(command_buffer, source_stage, destination_stage, 0, 0, nullptr, 0, nullptr, 1,
                         &barrier);
    return true;
}

bool Ps5VulkanRenderInterface::CopyBufferToImage(VkCommandBuffer command_buffer, VkBuffer buffer, VkImage image,
                                                  std::uint32_t width, std::uint32_t height)
{
    ...
    dispatch_.vkCmdCopyBufferToImage(command_buffer, buffer, image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &region);
    return true;
}
...
bool Ps5VulkanRenderInterface::CreateImageView(Texture &texture, VkFormat format)
{
    ...
    view_info.subresourceRange.layerCount = 1;
    return CheckResult(dispatch_.vkCreateImageView(device_, &view_info, nullptr, &texture.view), "dispatch_.vkCreateImageView(texture)");
}

bool Ps5VulkanRenderInterface::AllocateTextureDescriptor(Texture &texture)
{
    VkDescriptorSetAllocateInfo allocate = MakeVkStruct<VkDescriptorSetAllocateInfo>(VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO);
    allocate.descriptorPool = descriptor_pool_;
    allocate.descriptorSetCount = 1;
    allocate.pSetLayouts = &descriptor_set_layout_;
    if (!CheckResult(dispatch_.vkAllocateDescriptorSets(device_, &allocate, &texture.descriptor), "vkAllocateDescriptorSets"))
        return false;
    VkDescriptorImageInfo image_info{};
    image_info.sampler = texture.mip_levels > 1 ? mipmap_sampler_ : sampler_;
    image_info.imageView = texture.view;
    image_info.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
    VkWriteDescriptorSet write = MakeVkStruct<VkWriteDescriptorSet>(VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET);
...
bool Ps5VulkanRenderInterface::UploadTexture(Texture &texture, const std::uint8_t *pixels,
                                               std::uint32_t width, std::uint32_t height)
{
    VkDeviceSize bytes = static_cast<VkDeviceSize>(width) * height * 4;
    VkBuffer staging = VK_NULL_HANDLE;
    VkDeviceMemory staging_memory = VK_NULL_HANDLE;
    void *mapped = nullptr;
    if (!CreateBuffer(bytes, VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
                      VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, staging,
                      staging_memory, &mapped))
        return false;
    std::memcpy(mapped, pixels, static_cast<std::size_t>(bytes));
    VkCommandBuffer cmd = VK_NULL_HANDLE;
    if (!BeginSingleUseCommands(cmd, upload_command_pool_))
        return false;
    TransitionImage(cmd, texture.image, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL);
    CopyBufferToImage(cmd, staging, texture.image, width, height);
    TransitionImage(cmd, texture.image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
    const bool ok = EndSingleUseCommands(cmd, upload_command_pool_);
    DestroyBuffer(staging, staging_memory);
    return ok;
}

bool Ps5VulkanRenderInterface::CreateTextureFromPixels(const std::uint8_t *pixels, std::uint32_t width,
                                                        std::uint32_t height, VkFormat format, Texture **out_texture)
{
    ...
    if (!CreateImage(width, height, format, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT,
                     texture->image, texture->memory) ||
        !UploadTexture(*texture, pixels, width, height) ||
        !CreateImageView(*texture, format) || !AllocateTextureDescriptor(*texture))
    {
...
bool Ps5VulkanRenderInterface::CreateWhiteTexture()
{
    ...
    const bool ok = CreateTextureFromPixels(pixels, 1, 1, VK_FORMAT_R8G8B8A8_UNORM, &white_texture_);
    if (ok)
...
bool Ps5VulkanRenderInterface::CreateFrameResources()
{
    ...
    for (Frame &frame : frames_)
    {
        ...
        if (!CheckResult(dispatch_.vkCreateCommandPool(device_, &pool_info, nullptr, &frame.command_pool), "dispatch_.vkCreateCommandPool(frame)"))
            return false;
        VkCommandBufferAllocateInfo allocation = MakeVkStruct<VkCommandBufferAllocateInfo>(VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO);
        allocation.commandPool = frame.command_pool;
        allocation.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
        allocation.commandBufferCount = 1;
        if (!CheckResult(dispatch_.vkAllocateCommandBuffers(device_, &allocation, &frame.command_buffer), "dispatch_.vkAllocateCommandBuffers(frame)"))
            return false;
        VkSemaphoreCreateInfo semaphore = MakeVkStruct<VkSemaphoreCreateInfo>(VK_STRUCTURE_TYPE_SEMAPHORE_CREATE_INFO);
        if (!CheckResult(dispatch_.vkCreateSemaphore(device_, &semaphore, nullptr, &frame.image_available), "dispatch_.vkCreateSemaphore(image)"))
            return false;
        if (!CheckResult(dispatch_.vkCreateSemaphore(device_, &semaphore, nullptr, &frame.render_finished), "dispatch_.vkCreateSemaphore(render)"))
            return false;
        VkFenceCreateInfo fence = MakeVkStruct<VkFenceCreateInfo>(VK_STRUCTURE_TYPE_FENCE_CREATE_INFO);
        fence.flags = VK_FENCE_CREATE_SIGNALED_BIT;
        if (!CheckResult(dispatch_.vkCreateFence(device_, &fence, nullptr, &frame.fence), "vkCreateFence"))
            return false;
    ...
    {
        VkFramebufferCreateInfo info = MakeVkStruct<VkFramebufferCreateInfo>(VK_STRUCTURE_TYPE_FRAMEBUFFER_CREATE_INFO);
        ...
        info.layers = 1;
        if (!CheckResult(dispatch_.vkCreateFramebuffer(device_, &info, nullptr, &framebuffers_[i]), "vkCreateFramebuffer"))
            return false;
    }
    return true;
}
...
bool Ps5VulkanRenderInterface::HasDeviceExtension(VkPhysicalDevice device, const char *name) const
{
    ...
    std::vector<VkExtensionProperties> extensions(count);
    dispatch_.vkEnumerateDeviceExtensionProperties(device, nullptr, &count, extensions.data());
    for (const auto &extension : extensions)
...
{
    uint32_t count = 0;
    if (dispatch_.vkGetPhysicalDeviceDisplayPropertiesKHR(device, &count, nullptr) != VK_SUCCESS || count == 0)
        return false;
    std::vector<VkDisplayPropertiesKHR> displays(count);
    if (dispatch_.vkGetPhysicalDeviceDisplayPropertiesKHR(device, &count, displays.data()) != VK_SUCCESS)
        return false;
...
bool Ps5VulkanRenderInterface::ReadTextTextureHeader(const std::vector<std::uint8_t> &bytes, int &width, int &height) const
{
    if (bytes.size() < 18)
        return false;
                                               ...
                                               Rml::Vector2i &texture_dimensions)
{
    ...
    const bool supported_format = format == VK_FORMAT_R8G8B8A8_UNORM ||
    ...
    if (!supported_format || type_size != 1 || width == 0 || height == 0 || width > 16384 || height > 16384 ||
        depth != 0 || layers != 0 || faces != 1 || level_count == 0 || level_count > max_levels ||
        level_count > 32 || supercompression != 0 || sgd_length != 0 || dfd_length == 0 ||
        index_end > file_size || dfd_end > file_size || (kvd_length != 0 && kvd_end > file_size))
    {
        std::fprintf(stderr,
                     "[PS5-Vulkan] unsupported KTX2 layout: %s format=%u size=%ux%u levels=%u supercompression=%u\n",
                     source.c_str(), static_cast<unsigned>(format), width, height, level_count, supercompression);
        return close_and_fail();
    }
    ...
    for (std::uint32_t level_index = 0; level_index < level_count; ++level_index)
    {
        ...
        const long index_offset = static_cast<long>(80ull + static_cast<std::uint64_t>(level_index) * 24ull);
        if (std::fseek(file, index_offset, SEEK_SET) != 0 ||
            std::fread(level_index_bytes, 1, sizeof(level_index_bytes), file) != sizeof(level_index_bytes))
            return close_and_fail();
        ...
        const std::uint64_t expected_length = static_cast<std::uint64_t>(level_width) * level_height * 4ull;
        if (offset < minimum_data_offset || (offset & 3u) != 0 || byte_length != expected_length ||
            uncompressed_length != expected_length || offset > file_size || byte_length > file_size - offset)
        {
            std::fprintf(stderr, "[PS5-Vulkan] invalid KTX2 mip %u in %s\n", level_index, source.c_str());
            return close_and_fail();
        }
        Ktx2MipLevel level{};
        level.offset = offset;
    ...
    if (!CreateImage(width, height, format, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT,
                     texture->image, texture->memory, level_count))
    {
        DestroyTexture(texture);
        return close_and_fail();
    }
    ...
    for (std::uint32_t level_index = 0; level_index < level_count && !uploaded; ++level_index)
    {
        ...
        const std::uint32_t rows_per_chunk = std::max(
            1u, static_cast<std::uint32_t>(kTextureUploadChunkBytes / row_bytes));
...
bool Ps5VulkanRenderInterface::DecodeRadioAtlas(const std::vector<std::uint8_t> &payload,
                                                 std::vector<std::uint8_t> &pixels,
                                                 std::uint32_t width, std::uint32_t height)
{
    const std::size_t count = static_cast<std::size_t>(width) * height;
    pixels.assign(count * 4, 255);
    std::size_t input = 0;
    std::size_t output = 0;
    while (input < payload.size() && output < count)
    {
        ...
        else
        {
            ...
            for (std::size_t i = 0; i < length; ++i)
            {
                ...
                const std::uint8_t alpha = (i & 1u) ? ((packed & 0x0f) * 17u) : ((packed >> 4) * 17u);
                pixels[(output + i) * 4 + 3] = alpha;
            }
            input += bytes;
        }
        output += length;
...
bool Ps5VulkanRenderInterface::ReadTextureFile(const Rml::String &source, std::vector<std::uint8_t> &pixels,
                                                int &width, int &height)
{
    ...
    if (bytes.size() >= 16 && std::memcmp(bytes.data(), "RTA1", 4) == 0)
    {
        ...
        if (width <= 0 || height <= 0 || pixel_count != static_cast<std::uint32_t>(width * height) ||
            bytes.size() != 16ull + payload_length)
            return false;
        std::vector<std::uint8_t> payload(bytes.begin() + 16, bytes.end());
        return DecodeRadioAtlas(payload, pixels, static_cast<std::uint32_t>(width), static_cast<std::uint32_t>(height));
    }
...
bool Ps5VulkanRenderInterface::LoadTexture(Rml::TextureHandle &texture_handle, Rml::Vector2i &texture_dimensions,
                                             const Rml::String &source)
{
    ...
    int width = 0;
    int height = 0;
    if (!ReadTextureFile(source, pixels, width, height))
        return false;

    VkFormat format = VK_FORMAT_B8G8R8A8_UNORM;
    if (source.find("lvgl-bitmap") != Rml::String::npos)
    {
    ...
    if (!CreateTextureFromPixels(pixels.data(), static_cast<std::uint32_t>(width), static_cast<std::uint32_t>(height),
                                 format, &texture))
        return false;
...
bool Ps5VulkanRenderInterface::GenerateTexture(Rml::TextureHandle &texture_handle, const Rml::byte *source,
                                                const Rml::Vector2i &dimensions)
{
    ...
    if (!source || dimensions.x <= 0 || dimensions.y <= 0)
        return false;
    Texture *texture = nullptr;
    if (!CreateTextureFromPixels(reinterpret_cast<const std::uint8_t *>(source), static_cast<std::uint32_t>(dimensions.x),
                                 static_cast<std::uint32_t>(dimensions.y), VK_FORMAT_R8G8B8A8_UNORM, &texture))
        return false;
    texture_handle = reinterpret_cast<Rml::TextureHandle>(texture);
    return true;
}
...
void Ps5VulkanRenderInterface::SetScissorRegion(int x, int y, int width, int height)
{
    ...
    if (scissor_.offset.x + static_cast<int>(scissor_.extent.width) > static_cast<int>(extent_.width))
        scissor_.extent.width = extent_.width - std::min(extent_.width, static_cast<std::uint32_t>(scissor_.offset.x));
    if (scissor_.offset.y + static_cast<int>(scissor_.extent.height) > static_cast<int>(extent_.height))
        scissor_.extent.height = extent_.height - std::min(extent_.height, static_cast<std::uint32_t>(scissor_.offset.y));
}
...
void Ps5VulkanRenderInterface::BeginFrame()
{
    ...
    VkResult acquire = dispatch_.vkAcquireNextImageKHR(device_, swapchain_, UINT64_MAX, frame.image_available, VK_NULL_HANDLE,
    ...
    VkRenderPassBeginInfo pass = MakeVkStruct<VkRenderPassBeginInfo>(VK_STRUCTURE_TYPE_RENDER_PASS_BEGIN_INFO);
    ...
    const float viewport[2] = {static_cast<float>(extent_.width), static_cast<float>(extent_.height)};
    dispatch_.vkCmdPushConstants(frame.command_buffer, pipeline_layout_, VK_SHADER_STAGE_VERTEX_BIT, 0, sizeof(viewport), viewport);
    const VkViewport dynamic_viewport{
        0.0f, 0.0f, static_cast<float>(extent_.width), static_cast<float>(extent_.height), 0.0f, 1.0f};
...
void Ps5VulkanRenderInterface::RenderGeometry(Rml::Vertex *rml_vertices, int num_vertices, int *indices, int num_indices,
                                               Rml::TextureHandle texture, const Rml::Vector2f &translation)
{
    ...
    if (vertex_bytes > max_vertex_bytes_ - frame_vertex_cursor_ ||
        index_bytes > max_index_bytes_ - frame_index_cursor_ ||
        !frame.vertex_mapped || !frame.index_mapped)
    {
        std::fprintf(stderr,
                     "[PS5-Vulkan] UI frame buffer capacity exceeded (vertices=%llu/%llu indices=%llu/%llu)\n",
    ...
    auto *destination_vertices = reinterpret_cast<Vertex *>(static_cast<std::uint8_t *>(frame.vertex_mapped) + vertex_base);
    auto *destination_indices =
        reinterpret_cast<std::uint32_t *>(static_cast<std::uint8_t *>(frame.index_mapped) + index_base);
    ...
    dispatch_.vkCmdBindVertexBuffers(frame.command_buffer, 0, 1, &frame.vertex_buffer, &vertex_offset);
    dispatch_.vkCmdBindIndexBuffer(frame.command_buffer, frame.index_buffer, static_cast<VkDeviceSize>(index_base), VK_INDEX_TYPE_UINT32);
    ...
    dispatch_.vkCmdBindDescriptorSets(frame.command_buffer, VK_PIPELINE_BIND_POINT_GRAPHICS, pipeline_layout_, 0, 1,
    ...
    dispatch_.vkCmdDrawIndexed(frame.command_buffer, static_cast<std::uint32_t>(num_indices), 1, 0, 0, 0);
}
...
bool Ps5VulkanRenderInterface::EndFrame()
{
    ...
    if (!CheckResult(dispatch_.vkQueueSubmit(graphics_queue_, 1, &submit, frame.fence), "dispatch_.vkQueueSubmit(frame)"))
        return false;
